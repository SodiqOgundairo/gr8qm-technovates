        ...
        <Container className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 flex flex-col gap-6">
            <div className="bg-iceblue/40 border border-skyblue rounded-full px-4 py-2 w-fit">
              <p className="text-sm text-oxford font-medium">DESIGN & BUILD</p>
            </div>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-light border border-gray-200 rounded-xl p-6 hover:border-skyblue hover:shadow-lg transition-all duration-300"
              >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start gap-3">
                    <FaCheck className="text-iceblue text-xl mt-1 flex-shrink-0" />
